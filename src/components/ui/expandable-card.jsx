    ...
    <>
      ...
      <AnimatePresence>
        {active && (
          <div
            className={cn(
              "fixed inset-0 z-[100] flex items-center justify-center before:pointer-events-none"
            )}>
            <motion.div
              ...
              <div
                ...
                <motion.button
                  ...
                  className="absolute top-4 right-4 z-50 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-gray-200/90 bg-zinc-50 text-neutral-700 transition-colors duration-300 hover:border-gray-300/90 hover:bg-neutral-50 hover:text-black focus:outline-none dark:border-zinc-900 dark:bg-zinc-950 dark:text-white/70 dark:hover:border-zinc-800 dark:hover:bg-neutral-950 dark:hover:text-white"
                ...
                <div className="flex h-auto flex-col items-center justify-center gap-2 p-8">
                ...
                <div className="relative px-6 sm:px-8">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="flex flex-col items-center gap-4 overflow-auto pb-10 text-base text-zinc-500 text-center dark:text-zinc-400">
                    {children}
                  </motion.div>
                </div>
                </div>
